...
const dummyUrls = [
  {
    _id: "1",
    originalUrl:
      "https://www.amazon.com/Ultimate-Controller-Joysticks-Remappable-Gaming-Console/dp/B0D739FJLG/ref=sr_1_24?_encoding=UTF8&sr=8-24",
    shortCode: "SDFDD",
    Clicks: 9,
  },
  {
...
function App() {
  ...
  async function createShortUrl() {
    ...
    setCurrentUrl({
      originalUrl: response.data.data.orignalUrl,
  ...
  return (
    <main className="p-10 flex flex-col gap-4">
      <div className="w-full max-w-4xl p-2 flex gap-2 ">
        ...
        />
        <button
          className=" rounded p-2 bg-amber-600 text-white cursor-pointer"
        ...
        return (
          <div className="border border- bg-neutral-200 p-2 flex gap-4 justify-evenly items-center">
            ...
            <div className="flex gap-2">
              <button
               className="p-2 rounded bg-amber-600 text-white cursor-pointer">
                COPY
              </button>
